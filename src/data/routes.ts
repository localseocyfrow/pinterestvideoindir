...
export const ROUTES: Route[] = [
  ...
  { path: '/pinterest-video-indirici-nedir/', title: 'Pinterest Video İndirici Nedir — tanım, türler & sınırlar', changefreq: 'monthly', priority: 0.7 },
  { path: '/pinterest-downloader-nedir/', title: 'Pinterest Downloader Nedir — terimin Türkçe karşılığı', changefreq: 'monthly', priority: 0.65 },
  { path: '/pinterest-video-indirme-araci-nasil-calisir/', title: 'Pinterest Video İndirme Aracı Nasıl Çalışır — adım adım', changefreq: 'monthly', priority: 0.65 },
  ...
  { path: '/telif-hakki-ve-pinterest-indirme/', title: 'Telif Hakkı ve Pinterest İndirme — genel rehber', changefreq: 'monthly', priority: 0.5 },
  { path: '/nasil-kullanilir/', title: 'Nasıl Kullanılır — Pinterest indirme rehberi', changefreq: 'monthly', priority: 0.7 },
  { path: '/sss/', title: 'Sıkça Sorulan Sorular (SSS) — Pinterest indirme yardım merkezi', changefreq: 'monthly', priority: 0.7 },
